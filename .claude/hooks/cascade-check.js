#!/usr/bin/env node
/**
 * Cascade Rule Check Hook (PostToolUse on Edit|Write) — Claude adapter.
 * Envelope: ./_claude-edit-hook.js. Policy: shared tool-agnostic
 * .agents/hooks/policies/edit.js → cascadeCheck (also used by pi adapter).
...
H.start((data) => P.cascadeCheck(data));
