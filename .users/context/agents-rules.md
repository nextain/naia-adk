...
- **session_rollover**: Past about 200K tokens of context, write a handoff and continue in a fresh session. Backstops: CLAUDE_CODE_AUTO_COMPACT_WINDOW in .claude/settings.json and Grok's user-level [session] auto_compact_threshold_percent.
