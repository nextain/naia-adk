...
const EVENT_SOURCES = new Map([
	...
	["backend_ready", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["phase_changed", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["output_activity", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["progress_reported", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["prompt_cache_observed", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["tool_started", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["tool_finished", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["approval_required", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
	["checkpoint_saved", new Set(["helper", "codex", "claude", "opencode", "grok", "fake_backend"])],
	...
	["result_reported", new Set(["codex", "claude", "opencode", "grok", "fake_backend"])],
...
const EXTERNAL_EVENT_SOURCES = new Set(["codex", "claude", "opencode", "grok", "fake_backend"]);
...
export class SessionEventWriter {
	...
	appendEvent({
		...
		if (!new Set(["gateway", "helper", "codex", "claude", "opencode", "grok", "fake_backend", "host_verifier", "backend_claim", "human_review", "recovery"]).has(source)) {
