...
function verifyCurrentCanaryExecutionBinding(paths, storedBinding) {
	...
	const snapshot = buildAgentContextSnapshot({ workspace, agentId: config.workspace.agentId, entrypoint: config.workspace.entrypoint, contextFiles: config.workspace.contextFiles, personaSourceRoot: config.persona?.source === "naia-settings" ? paths.root : null });
