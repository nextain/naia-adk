 ...
 * alpha·naia-corp 처럼 이름 붙여 쓰는 워크스페이스에는 그 이름의 설정이 없어서
 * 설치가 통째로 막힌다. 2026-08-20 naia-corp 게이트웨이 승격이 여기서 멈췄다.
 */
test("런처 프로브는 설치 중인 인스턴스로 실행된다", () => {
	...
	try {
		...
		const launcher = installOperatorLauncher(root, { directory, probeInstance: "naia-corp" });
...
test("probeInstance 를 주면 --instance 가 인자에 들어간다", () => {
	...
	assert.deepEqual(withInstance("naia-corp"), ["--instance", "naia-corp", "service", "unit"]);
