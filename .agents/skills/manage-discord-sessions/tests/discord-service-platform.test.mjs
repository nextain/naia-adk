...
test("DSG-008 Bash entrypoint preserves every top-level CLI command", () => {
	...
	for (const command of ["status", "health-check", "jobs", "job", "watch", "logs", "monitor", "cancel", "restart", "amend", "submit", "history", "latest", "attachment", "reply", "service", "cutover", "artifacts"]) {
