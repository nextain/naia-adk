...
The ADK development role and runner policy is documented in
[`docs/development-model-routing.md`](docs/development-model-routing.md). It
keeps Codex as the integration authority, automatically escalates expert work to
Sol, assigns Terra-only substantive adversarial review, and routes HY3 work
